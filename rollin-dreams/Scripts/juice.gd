...
func _on_body_entered(body):
	if body.has_method("enterJuice"):
		player_in_area = body
		body.enterJuice()  # Call the player's enterJuice method
		print("Player entered juice area")

func _on_body_exited(body):
	if body.has_method("exitJuice"):
		player_in_area = null
		body.exitJuice()  # Call the player's exitJuice method
		stop_sound()
		print("Player exited juice area")
